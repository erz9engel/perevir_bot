...
//TEST
function getMailBtn () {
    const inline_keyboard = [[{text: 'Налаштування розсилки', callback_data: 'NEWSLETTER_SETTINGS'}],[{text: '🔎 Дізнатися більше', url: 'https://t.me/gwaramedia'}]];
...
const text = '🤯 #фейкотня від вівторка 28 червня\n\n👉🏻 Фейк\nБританці незадоволені тим, що Лондон надає Києву нові кредитні гарантії на 525 мільйонів доларів.\n\n👉🏻 Фейк\nГенштаб просить Офіс Президента посилити законодавство для реалізації повномасштабної мобілізації в Україні.'
bot.sendMessage(394717645, text, options);
